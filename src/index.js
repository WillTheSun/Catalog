...
import { loadSamples, removeFish, addFish, increase, decrease, updateFish } from './components/FishUtils';
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Inventory fishList={this.state.fishList} remove={removeFish.bind(this)} addFish={addFish.bind(this)} updateFish={updateFish.bind(this)}/>
            </div>
        );
    }
}
